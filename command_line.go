...
func ParseCommandLine(app *kingpin.Application) (*cmd.CommandLine, error) {
	...
	app.Flag("retry", "Number of retry attempts for non-successful API responses including failed authentication requests and response timeouts").Short('R').Default("0").IntVar(&cmdLine.Retry)
