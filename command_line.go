...
func ParseCommandLine(app *kingpin.Application) (*cmd.CommandLine, error) {
	...
	app.Flag("dump", "Dump HTTP request and response. Possible values are 'debug' or 'json'.").EnumVar(&d, "debug", "json", "record")
