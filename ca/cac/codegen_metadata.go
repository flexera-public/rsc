...
2,083 characters we recommend using a POST request with the parameters in the body.`,
		Actions: []*metadata.Action{
			...
			&metadata.Action{
				Name:        "export",
				Description: `Exports the cloud bills for the time range given, along with the instance data for non-AWS providers, with columns for each account tag.`,
				PathPatterns: []*metadata.PathPattern{
					&metadata.PathPattern{
						HTTPMethod: "GET",
			...
			&metadata.Action{
				...
				CommandFlags: []*metadata.ActionParam{
					...
					&metadata.ActionParam{
						...
						Mandatory:   true,
						NonBlank:    false,
						ValidValues: []string{"Amazon Web Services", "Eucalyptus", "Rackspace", "CloudStack", "OpenStack", "SoftLayer", "Sunrise", "Google", "Microsoft Azure", "HP", "Blue Skies", "VMware", "Datapipe", "IDC Frontier", "Logicworks"},
					},
					&metadata.ActionParam{
