...
v6.1.0
[![Build Status](https://travis-ci.org/rightscale/rsc.svg?branch=v6.1.0)](https://travis-ci.org/rightscale/rsc)
...
$ chmod +x ./rsc
$ ./rsc --version
rsc v6.1.0 - 2016-08-10 00:34:20 - 308f4fcbf12da4b94d6fd683c25dd86deb35237e
```

#### Versioning

- To download the latest stable use the links with 'v6' in them.
- To download a specific version, replace the 'v6' by the exact version, such as 'v6.1.0'.
- All versions with the same major number (e.g. 'v6') are intended to be "upward" compatible.
- The 'v6' links download a specific version, so `rsc --version` will print something like 'v6.1.0'
  and not 'v6'.
