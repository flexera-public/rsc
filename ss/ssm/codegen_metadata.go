		...
		Actions: []*metadata.Action{
			...
			&metadata.Action{
				...
				CommandFlags: []*metadata.ActionParam{
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][current_schedule]",
						Description: `The currently selected schedule name, or nil for CloudApps using the '24/7' schedule`,
						Type:        "string",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][next_action][execution_schedule]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedule_required]",
						Description: `Whether the CloudApp requires a schedule. If set to false, allows user to pick from '24/7' schedule in the UI`,
						Type:        "bool",
						Location:    metadata.PayloadParam,
						Mandatory:   false,
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][status]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][created_from]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][description]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][name]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][start_recurrence][hour]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][start_recurrence][minute]",
					...
					&metadata.ActionParam{
						Name:        "latest_notifications[][execution][schedules][][start_recurrence][rule]",
